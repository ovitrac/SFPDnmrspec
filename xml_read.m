function [tree, RootName, DOMnode] = xml_read(xmlfile, varargin) %function [tree, RootName, DOMnode] = xml_read(xmlfile, Pref)
...
%
% INRA\Olivier Vitrac - revision 16/03/10
...
if (nargin>1)
  Pref = argcheck(varargin,DPref,'','keep');
